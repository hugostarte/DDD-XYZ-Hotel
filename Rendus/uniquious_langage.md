...
Acompte obligatoire : 50% du montant total à la réservation.   
Chambre individuelle : Chaque chambre est considérée pour 1 personne.  
Gestion du stock : Respect de la disponibilité des chambres.  
Pas de remboursement : Aucun remboursement en cas d'annulation.  
...
Solde restant : Montant restant à régler après versement de l'acompte.  
Période de séjour : Durée définie par une date d'arrivée et une date de départ.  
Disponibilité : État d'une chambre libre pour une période donnée.  
Conversion de devise : Transformation automatique de toute devise etrangère en euros.  
Annulation : Action d'annuler une reservation sans possibilite de remboursement.  
Stock de chambres : Nombre de chambres disponibles par categorie.  
Tarification : Prix par nuit selon la categorie de chambre.  
Équipements : Services et objets inclus dans chaque catégorie de chambre.  
